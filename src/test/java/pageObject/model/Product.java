...
public class Product {
    ...
    public class Builder {
        ...
        public Builder withDimX(String dimX) {
            Product.this.dimX = dimX;
            return this;
        }

        public Builder withDimY(String dimY) {
            Product.this.dimY = dimY;
            return this;
        }

        public Builder withDimZ(String dimZ) {
            Product.this.dimZ = dimZ;
            return this;
        }

        public Builder withStatusId(int statusId) {
            Product.this.statusId = statusId;
            return this;
        }
        ...
        public Builder withManId(int manId) {
            Product.this.manId = manId;
            return this;
        }
        ...
        public Builder withAttributes(String attributes) {
            Product.this.attributes = attributes;
            return this;
        }
        ...
        public Builder withUSDPrice(String USDPrice) {
            Product.this.USDPrice = USDPrice;
            return this;
        }

        public Builder withEURPrice(String EURPrice) {
            Product.this.EURPrice = EURPrice;
            return this;
        }
